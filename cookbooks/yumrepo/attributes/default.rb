...
# Centos Base
default[:repo][:centos_base][:url] = "http://mirror.centos.org/centos/6/os/x86_64/"
...
default[:repo][:remi][:key] = "RPM-GPG-KEY-remi"

# RPMForge
default[:repo][:rpmforge][:url] = "http://apt.sw.be/redhat/el5/en/$basearch/rpmforge"
default[:repo][:rpmforge][:enabled] = true
default[:repo][:rpmforge][:key] = "RPM-GPG-KEY-rpmforge-dag"
